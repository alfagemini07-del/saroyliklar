...
CATEGORIES = {
    ...
    "bakery": {"icon": "🥐", "name": "Nonvoyxona", "color": "#a8672a"},
    "cafe": {"icon": "☕", "name": "Kafe va choyxona", "color": "#8f5b3f"},
    ...
    "barber": {"icon": "✂️", "name": "Sartaroshxona", "color": "#354f68"},
    ...
    "agriculture": {"icon": "🌾", "name": "Dehqonchilik", "color": "#5f7f2c"},
    "auto": {"icon": "🚗", "name": "Avto xizmat", "color": "#355c7d"},
    "education": {"icon": "📚", "name": "Ta'lim", "color": "#7c4d9e"},
    "transport": {"icon": "🚕", "name": "Transport", "color": "#c68a00"},
    "crafts": {"icon": "🧵", "name": "Hunarmandchilik", "color": "#9b4f68"},
